...
\input{/home/meg/presentations/slides/waterscape_perivascular_mechanism.tex}
...
\begin{columns}[T]
  ...
  \end{column}
  \begin{column}{0.4\textwidth}
      \includegraphics[width=\textwidth]{/home/meg/papers/current/hikeandsurf/Book/graphics/chp2/exp-matters.png}
  \end{column}
\end{columns}
