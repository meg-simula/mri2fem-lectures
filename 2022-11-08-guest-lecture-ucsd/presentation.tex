...
\frame{
  \frametitle{Interdisciplinary overview and goals of lecture}
  \begin{enumerate}
  \item
    Motivation (5 min)
  \item
  ...
  \item
    The brain as a Stokes-Biot coupled problem (30 min)
  \item
    Break (5 min)
  \item
    Simulating brain pulsatility (15 min)
  \item
  ...
  \begin{enumerate}
  \item
    Understand core aspects of brain physiology and mechanics
  \item
    Understand how the brain can be modelled as a poroelastic medium
...
\mysection{The brain as a poroelastic medium (in a fluid environment)}
...
%\input{/home/meg/presentations/slidesx/ern_meunier.tex}

\mysection{Finite element methods for Stokes-Biot coupled problems}
