...
\begin{enumerate}
  \item
    Motivation 
  \item
    Brain physiology and physics 
  \item
    Finite elements for brain poroelasticity
  \item[]
  \textcolor{gray}{Break} 
  \item
...
\begin{frame}[fragile]
  \frametitle{FEniCS implementation of Biot discrete forms}
  \vspace{-1.2em}
  \begin{columns}[T]
...
I = Identity(d)
sigma = lambda u : \
    2*mu*eps(u) + lmbda*div(u)*I

# Define variational forms
a = (inner(sigma(u), eps(v))
     + alpha*div(v)*p
     + alpha*div(u)*q
     - s*p*q
     - inner(kappa*grad(p), grad(q))
     )*dx()
L = (dot(f, v) + g*q
     - s*p_*q + alpha*div(u_)*q)*dx()
...
\blackframe{
  \frametitle{These slides and other lecture material are available via GitHub}
  {\centering
  \includegraphics[width=\textwidth]{graphics/mri2fem-lectures-github.png} 
  }
  \vspace{-8em}
  \referself{\href{https://github.com/meg-simula/mri2fem-lectures}{https://github.com/meg-simula/mri2fem-lectures}}
}
  
\blackframe{
  \frametitle{Mathematical modeling of the human brain: from MRI to FEM}

  \begin{columns}[T]
    \begin{column}{0.3\textwidth}
      \centering
      \includegraphics[width=\textwidth]{graphics/mri2fem_cover.jpg}
    \end{column}
  ...
  \referself{\href{https://github.com/kent-and/mri2fem}{https://github.com/kent-and/mri2fem}}
}
  
\begin{frame}
  \frametitle{Further resources (data sets, software) are available via Zenodo}
  \vspace{-0.5em}
  \centering
  \includegraphics[width=0.85\textwidth]{graphics/mri2fem-zenodo.png} \\
  \vspace{-1em}
  \referself{\href{https://zenodo.org/communities/mri2fem/}{https://zenodo.org/communities/mri2fem/}}
\end{frame}

\begin{frame}
  \frametitle{Step-by-step tutorial videos are available on YouTube}
  \centering
  \includegraphics[width=\textwidth]{graphics/mri2fem-youtube.png} \\
  \vspace{-1em}
  \referself{\href{https://www.youtube.com/playlist?list=PL2H4xO8DvXwVNy7EelY\_TuYUgvQ4Dw\_Lz}{https://www.youtube.com/playlist?list=PL2H4xO8DvXwVNy7EelY\_TuYUgvQ4Dw\_Lz}}
\end{frame}
...
\begin{column}{0.3\textwidth}
  \centering
  \includegraphics[width=0.4\textwidth]{/home/meg/papers/published/mri2fem/book/graphics/chp2/T1-image.png} \\
  \includegraphics[width=0.8\textwidth]{/home/meg/papers/published/mri2fem/book/graphics/chp3/taubin-smoothed-10.png} \\
  \includegraphics[width=0.8\textwidth]{/home/meg/papers/published/mri2fem/book/graphics/chp1/ernie-volume-64.png} \\
\end{column}
\end{columns}
...
\item
  ...
  \begin{itemize}
  \item
    these slides: \href{https://github.com/meg-simula/mri2fem-lectures/2022-11-08-lecture.pdf}{https://github.com/meg-simula/mri2fem-lectures/2022-11-08-lecture.pdf}.
  \item
    the mri2fem data set and software ($\sim$ 1Gb) 
    \href{https://zenodo.org/communities/mri2fem/}{https://zenodo.org/communities/mri2fem/}
  \item
    the \emph{Mathematical modelling of the human brain: from MRI to FEM} book: \\ \href{https://github.com/kent-and/mri2fem}{https://github.com/kent-and/mri2fem}.
  \end{itemize}
\item
  Install software dependencies following the instructions in Chapter
  2 of Mardal et al (2021).
\item
  Inspect the data set contents using the tools described (e.g.~DicomBrowser, FreeSurfer)
\item
  Try running some of the sample code in Chapter 3 of the book.
\item
